...
def get_twitter_accounts_stats(
        use_credibility: bool = Query(False, description='Wether to use the old model (false) or the new one based on credibility (legacy data interface as the old model)')
        ):
