...
def post_frontend_v2_profile_credibility(
    screen_name: str = Query(..., description='The screen name of the profile to be analysed'),
...
def get_frontend_v2_tweet_credibility(
    ...
    if not wait:
        return jobs_manager.create_task_for(credibility_manager.get_v2_tweet_credibility, tweet_id)
    else:
