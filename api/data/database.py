...
def get_homepage_stats_v2():
    ...
    profiles_misinformed_count = reviewed_profiles_v2.count_documents(
        {"tweets_analysed_stats.tweets_not_credible_count": {"$gt": 0}}
    )
    tweets_misinformed_count = reviewed_tweets_v2.count_documents(
        {"coinform_label": "not_credible"}
    )
    return {
