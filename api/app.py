...
tags_metadata = [
    ...
    {
        "name": "analysis",
        "description": "Analysis of some entities. Deprecated version. Use credibility.",
    },
    {
        "name": "credibility",
    ...
    {"name": "twitter", "description": "Interfacing with the twitter connector"},
]
...
app = FastAPI(
    title="MisinfoMe API",
    description="API for the MisinfoMe project",
    version="0.3.0",
